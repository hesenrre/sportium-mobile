 ...
 * Copyright (c) 2009-2011 by sportium, Inc. All Rights Reserved.
...
//@interface sportiumObject : NSObject
//@end

@interface sportiumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[sportiumObject class]])
		{
			for (NSString *key in [[(sportiumObject*)o modules] allKeys])
			{
