...
// in simulator we redefine to format for sportium Developer console
...
{\
	NSString * exceptionName = [@"org.sportium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sportium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsportiumNativeItemNone = -1, 
	UIsportiumNativeItemSpinner = -2,
	UIsportiumNativeItemProgressBar = -3,
	
	UIsportiumNativeItemSlider = -4,
	UIsportiumNativeItemSwitch = -5,
	UIsportiumNativeItemMultiButton = -6,
	UIsportiumNativeItemSegmented = -7,
	
	UIsportiumNativeItemTextView = -8,
	UIsportiumNativeItemTextField = -9,
	UIsportiumNativeItemSearchBar = -10,
	
	UIsportiumNativeItemPicker = -11,
	UIsportiumNativeItemDatePicker = -12,
	
	UIsportiumNativeItemInfoLight = -13,
	UIsportiumNativeItemInfoDark = -14,
	
	UIsportiumNativeItemDisclosure = -15,
	
	UIsportiumNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all sportium instances of
